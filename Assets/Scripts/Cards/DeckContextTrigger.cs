...
public class DeckContextTrigger : ContextTriggerOverride
{
    ...
    public override void OnPointerDown(PointerEventData eventData)
    {
        if (eventData.button == PointerEventData.InputButton.Right)
        {
            ...
            m_ContextMenu.AddMenuItem("Flip", delegate {
                ...
                deckObject.GetComponent<CardBehaviour>().CardInteract(1);
            });
            m_ContextMenu.AddMenuItem("Shuffle", delegate {
                Debug.Log("Shuffle Clicked");
                deckObject.GetComponent<DeckScript>().shuffle();
            });
